...
import TokenLinkType from '../../components/TokenLinkType'
...
**Type**
<br/>
<TokenLinkType tokens={['HaetaePreConfig', 'HaetaeConfig']}>
...
- `recordRemoval.age?{:ts}`: Age threshold by milliseconds. Records whose age are older than this value are to be removed when calling [`addRecord`](#addrecord).
- `recordRemoval.count?{:ts}`: The number of total records to keep. When the number of records becomes larger than this value, old records are removed to satisfy the threshold when calling [`addRecord`](#addrecord). This task is executed after that of `recordRemoval.age`.
...
**Type**
<br/>
<TokenLinkType tokens={['GetConfigOptions', 'HaetaeConfig']}>
`<D = unknown, E = unknown>(options?: GetConfigOptions) => Promise<HaetaeConfig<D, E>>{:ts}`
</TokenLinkType>
...
**Type**
<br/>
<TokenLinkType tokens={['HaetaeStore']}>
...
**Type**
<br/>
<TokenLinkType tokens={['GetStoreOptions', 'HaetaeStore']}>
...
**Type**
<br/>
<TokenLinkType tokens={['GetRecordsOptions', 'HaetaeRecord']}>
...
**Type**
<br/>
<TokenLinkType tokens={['CommandFromConfig']}>
...
**Type**
<br/>
<TokenLinkType tokens={['GetRecordOptions', 'HaetaeRecord']}>
...
**Type**
<br/>
<TokenLinkType tokens={['FormRecordOptions', 'HaetaeRecord']}>
...
**Type**
<br/>
<TokenLinkType tokens={['AddRecordOptions', 'HaetaeStore']}>
...
- `store?{:ts}` : A store object. <small>(default: [`getStore(){:ts}`](#getstore))</small>
- `record?{:ts}` : A new record object to add. <small>(default: [`formRecord({ data: invokeRun({ command }), env: invokeEnv({ command }) }){:ts}`](#formrecord))</small>
...
**Type**
<br/>
<TokenLinkType tokens={['SaveStoreOptions']}>
...
**Type**
<br/>
<TokenLinkType tokens={['FilenameOption']}>
