...
<small>(default: Where *`.git`* resides. If not found, [`core.getConfigDirname(){:ts}`](./haetae-core#getconfigdirname))</small>
...
The [Getting Started](../getting-started) guide explains the basic usage.
